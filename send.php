...
} elseif ($type === 'consultation' && $businessRole !== 'owner') {
    // Только бесплатная экспресс-консультация ограничена собственником;
    // платные диагностика и консультация доступны и наёмному сотруднику.
    $errors[] = 'Экспресс-консультация проводится только с собственником бизнеса';
}
